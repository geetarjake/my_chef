...
configure_options = node['php']['configure_options'].join("--with-pear", "--with-mysql", "--with-openssl", "--with-zlib", "--with-curl", "--with-gd", "--with-xmlrpc", "--with-mcrypt", "--enable-mbstring")
